...
def get_run_parser():
    parser = argparse.ArgumentParser(
        "Launcher arguments", parents=[get_submitit_parser()]
    )
    parser.add_argument(
        "module_path",
        type=str,
...
class CheckpointableSubmitter:
    ...
    def checkpoint(self):
        ...
        empty_class = type(self)(
            self.module_path, self.callable_name, self.args, self.output_dir
        )
...
def main():
    ...
    class_to_submit = CheckpointableSubmitter(
        args.module_path, args.callable_name, script_args, args.output_dir
    )
