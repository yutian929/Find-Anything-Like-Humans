...
class create_dc_ae_diffusion_model:
    def __init__(self, name: str, pretrained_path: Optional[str] = None):
        self.name = name
        self.pretrained_path = pretrained_path

    def __call__(self) -> EvaluatorConfig:
        return create_dc_ae_diffusion_model_cfg(self.name, self.pretrained_path)
